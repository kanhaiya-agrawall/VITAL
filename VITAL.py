...
st.set_page_config(
    page_title="VITAL - Virtual Initiative Tool for Assessing Health",
    layout="wide",
    page_icon="🩺"
)
...
st.title("VITAL - Virtual Initiative Tool for Assessing Health")
...
def main():
    ...
    if selected == "Home":
        ...
        st.subheader("Thank you for using VITAL! We hope you find the application helpful and informative. If you have any questions or feedback, please feel free to contact us.")        
